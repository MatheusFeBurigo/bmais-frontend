...
type InsightTom = 'info' | 'warning' | 'primary' | 'muted'
interface Insight { clr: InsightTom; title: string; desc: string; status: string }
...
function derivarInsights(data: DiretoriaPayload): Insight[] {
  ...
  return [
    ...
    },
    {
      ...
      status: `${setaTrend} ${atual} (${delta >= 0 ? '+' : ''}${delta})`,
    },
    {
